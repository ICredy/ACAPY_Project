...
from .utils  import(
    flatten, log_json, log_msg, log_timer, output_reader
)
...
async def default_genesis_txns():
    ...
    try:
        if GENESIS_URL:
            ...
            with open("aries-cloudagent-python-467104fab662507e18483abaaf2305bc702bb303/demo/runners/support/local-genesis.txt", "r") as genesis_file:
                genesis = genesis_file.read()
    except Exception:
